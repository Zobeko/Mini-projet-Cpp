...
public:
	...
	void checkMort(std::map<std::string, sf::Texture>& _textDictionnary, b2World& _world, sf::RenderWindow& window, sf::Music & musique);// Bloque le jeu pendant un certain temps puis recharge la salle précédente
