...
public:
	...
	virtual void Update(SceneManager & sceneManager, int iDpickUp);		// Supprime le pickup du vecteur de Pickup de SceneManager si le joueur le touche (cad intersectionne avec lui)
