...
Ombre::Ombre(int _x, int _y, int _h, std::map<std::string, sf::Texture>& textDictionnary) : PickUp(_x, _y, _h, abs(_h*tan(60)), "Ombre.png", textDictionnary) {
...
void Ombre::Update(SceneManager& sceneManager, int iDpickUp) {
